...
def start_quiz(statements):
    ...
    for statement in statements:
        ...
        # Show only the first word as [Hidden] and the rest of the statement
        statement_text_hidden = statement_word + " [Hidden] " + statement_text[len(statement_word)+1:]

        user_answer = input(f"\nStatement:\n{number}. {statement_text_hidden}\nEnter the correct word (Odu): ")
