...
root.configure(bg=COLOR_SCHEMES["Gruvbox"]["bg"])  # Set initial background color
frame = tk.Frame(root, bg=COLOR_SCHEMES["Gruvbox"]["bg"])  # Create a frame for centering
...
label = tk.Label(
    ...
    pady=10,
    font=("Helvetica", 12),
    fg=COLOR_SCHEMES["Gruvbox"]["fg"],
    bg=COLOR_SCHEMES["Gruvbox"]["bg"],
...
entry = tk.Entry(
    frame,
    font=("Helvetica", 12),
    bg=COLOR_SCHEMES["Gruvbox"]["entry_bg"],
    fg=COLOR_SCHEMES["Gruvbox"]["entry_fg"],
...
check_button = tk.Button(
    ...
    font=("Helvetica", 12),
    bg=COLOR_SCHEMES["Gruvbox"]["highlight_bg"],
    fg=COLOR_SCHEMES["Gruvbox"]["fg"],
)
check_button.pack()
...
tracker_label = tk.Label(
    ...
    font=("Helvetica", 10),
    fg=COLOR_SCHEMES["Gruvbox"]["label_fg"],
    bg=COLOR_SCHEMES["Gruvbox"]["bg"],
...
color_scheme_combo.set("Gruvbox")  # Set default color scheme
